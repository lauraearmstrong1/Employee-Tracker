...
CREATE TABLE employee(
  ...
  manager_id INTEGER(11) AUTO_INCREMENT NOT NULL,
  PRIMARY KEY (id)
);
...
INSERT INTO authors (firstName, lastName) values ('Jane', 'Austen'); -- id 1
INSERT INTO authors (firstName, lastName) values ('Mark', 'Twain'); -- id 2
INSERT INTO authors (firstName, lastName) values ('Lewis', 'Carroll'); -- id 3
INSERT INTO authors (firstName, lastName) values ('Andre', 'Asselin'); -- id 4
